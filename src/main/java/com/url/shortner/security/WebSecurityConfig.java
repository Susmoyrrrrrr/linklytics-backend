...
import org.springframework.security.config.Customizer;   // <-- এটা import থাকবে
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                .cors(Customizer.withDefaults())          // <-- এই লাইন যোগ করো
                .csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(HttpMethod.OPTIONS, "/**").permitAll() // <-- এই লাইন যোগ করো
